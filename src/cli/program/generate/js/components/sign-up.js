...
export default class GenerateSignUpComponent {
  ...
  return (
    <div className='sign-in'>
      ...
      <button
        onClick={async () => {
          try {
            const response = await ${apiName}.create({ ${keyField}, ${passwordField} })
...
`
    await File.write(config.pathTo(`src/components/SignUp.js`), template)
  }
}
