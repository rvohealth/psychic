...
export default function specHooks() {
  ...
  beforeEach(async () => {
    ...
    const packagedDreams = await import('app/pkg/dreams.pkg.js')
    const packagedChannels = await import('app/pkg/channels.pkg.js')
    const packagedProjections = await import('app/pkg/projections.pkg.js')
    const routeCB = await import('config/routes.js')
    const dbSeedCB = await import('db/seed.js')
