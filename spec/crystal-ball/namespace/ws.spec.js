...
describe('CrystalBall::Namespace#ws', () => {
  it ('calls #run, passing args', async () => {
    ...
    const result = ns.ws('fishman', 'fishmen#index', { fish: 10 })

    expect(spy).toHaveBeenCalledWith('ws', 'fishman', 'fishmen#index', { fish: 10, isWS: true })
