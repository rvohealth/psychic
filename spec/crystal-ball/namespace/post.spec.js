...
describe('CrystalBall::Namespace#post', () => {
  it ('calls #run, passing args', async () => {
    ...
    const result = ns.post('fishman', 'fishmen#index', { fish: 10 })

    expect(spy).toHaveBeenCalledWith('post', 'fishman', 'fishmen#index', { fish: 10 })
