...
describe('CrystalBall::Namespace#patch', () => {
  it ('calls #run, passing args', async () => {
    ...
    const result = ns.patch('fishman', 'fishmen#index', { fish: 10 })

    expect(spy).toHaveBeenCalledWith('patch', 'fishman', 'fishmen#index', { fish: 10 })
