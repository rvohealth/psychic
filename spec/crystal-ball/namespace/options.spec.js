...
describe('CrystalBall::Namespace#options', () => {
  it ('calls #run, passing args', async () => {
    ...
    const result = ns.options('fishman', 'fishmen#index', { fish: 10 })

    expect(spy).toHaveBeenCalledWith('options', 'fishman', 'fishmen#index', { fish: 10 })
