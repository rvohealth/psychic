import { DreamSerializer, SerializableDreamClassOrViewModelClass } from '@rvohealth/dream';
import PsychicController from '.';
import { OpenapiEndpointRendererOpts } from '../openapi-renderer/endpoint';
 ...
 */
export declare function OpenAPI<I extends SerializableDreamClassOrViewModelClass | SerializableDreamClassOrViewModelClass[] | typeof DreamSerializer>(modelOrSerializer?: I | OpenapiEndpointRendererOpts<I>, opts?: OpenapiEndpointRendererOpts<I>): (target: PsychicController, methodName: string | symbol) => void;
